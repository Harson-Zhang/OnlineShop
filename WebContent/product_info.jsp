...
<script type="text/javascript">
	function addToCart(){
		...
		location.href = "${pageContext.request.contextPath }/addProductToCart?pid=${productByPid.pid }&buyNum="+buyNum;
	}
</script>
			...
			<div style="margin: 0 auto; width: 950px;">
				<div class="col-md-6">
					<img style="opacity: 1; width: 400px; height: 350px;" title=""
						class="medium"
						src="${pageContext.request.contextPath }/${productByPid.pimage }">
				</div>

				<div class="col-md-6">
					<div>
						<strong>${productByPid.pname }</strong>
					</div>
					<div
						style="border-bottom: 1px dotted #dddddd; width: 350px; margin: 10px 0 10px 0;">
						<div>编号：${productByPid.pid }</div>
					</div>
					...
					<div>
						<a href="${pageContext.request.contextPath }/productListByCid?cid=${cid}&page=${page}">返回列表页面</a>
					</div>
