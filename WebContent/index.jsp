	...
	<body>
		<div class="container-fluid">
			...
			<div class="container-fluid">
				...
				<%-- <c:forEach items="${strs }" var="ele">
   		 			${ele } <br>
				</c:forEach> --%>

				<c:forEach items="${hotProductList }" var="hotPro"> <!-- 不得不用product里的cid了。。。 -->
					<div class="col-md-2" style="text-align:center;height:200px;padding:10px 0px;">
						<a href="${pageContext.request.contextPath }/productInfo?cid=${hotPro.cid}&pid=${hotPro.pid}">
							<img src="${pageContext.request.contextPath }/${hotPro.pimage }" width="130" height="130" style="display: inline-block;">
						</a>
						<p><a href="${pageContext.request.contextPath }/productInfo?cid=${hotPro.cid}&pid=${hotPro.pid}" style='color:#666'>${hotPro.pname }</a></p>
			...
			<div class="container-fluid">
				...
				<c:forEach items="${newProductList }" var="newPro">
					<div class="col-md-2" style="text-align:center;height:200px;padding:10px 0px;">
						<a href="${pageContext.request.contextPath }/productInfo?cid=${newPro.cid}&pid=${newPro.pid}">
							<img src="${pageContext.request.contextPath }/${newPro.pimage }" width="130" height="130" style="display: inline-block;">
						</a>
						<p><a href="${pageContext.request.contextPath }/productInfo?cid=${newPro.cid}&pid=${newPro.pid}" style='color:#666'>${newPro.pname }</a></p>
